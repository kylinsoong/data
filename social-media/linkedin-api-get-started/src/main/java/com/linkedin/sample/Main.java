...
public class Main {
    ...
    private static String API_KEY = "75ousjk79fegsa";
    private static String API_SECRET = "KRuVmchn7gmPzszh";
    ...
    public static void main(String[] args) {
        ...
        try{
            File file = new File("target/service.dat");
            ...
            if(file.exists()){
                ...
                ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream("target/service.dat"));
